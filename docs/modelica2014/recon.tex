...
associated with a value which is, in turn, a \msgpack\ map.
...
The following table attempts to summarize all the details presented so
far:

%\lstset{language=javascript}
%\begin{lstlisting}[frame=single]  % Start your code-block
\begin{verbatim}
0x72 0x65 0x63 0x6f 0x6e 0x31 0x77 0x61 0x6c 0x6c 0x3a 0x76 0x30 0x31 // ID
...
// Followed by zero or more field entries:
