...
Python dictionary.  We will do this again for both formats.  The
script for doing this with the \meld\ format looks as follows:
...
milliseconds) of: 886.35, 890.70, 897.53, 889.79, 891.42 for an
average of 891.16 milliseconds.

Similarly, we used the following script to extract the same signals
from the dsres file format:
...
% comparable storage requirements
