...
\item {\b easy to implement on a wide range of platforms} - An open
...
\item {\b efficient disk and network access} - These formats have been
...
\item {\b first-class metadata} - With metadata available at all
...
\item {\b tables containing mixed data types} - All data types are
...
\item {\b richer alias transformations} - The \recon\ formats support
...
\item {\b efficient treatment of strings} - MATLAB version 4 files are
...
\item {\b ability to store objects/structures} - Not all data is
